package classwork.supermarket.test;

import classwork.supermarket.dao.Supermarket;
import classwork.supermarket.dao.SupermarketImpl;
...
//        }
    ...
    void removeProduct() {
        ...
        assertNull(myMarket.removeProduct(222222));// we can not remove twice
    }
    ...
    void findByCategory() {
        ...
        int l = actual.size();
        Product[] productsActual = new Product[l];// переносим все значения из листа в массив
        int i = 0;
    ...
    @Test
    void findByBrand() {
        ArrayList<Product> actual = (ArrayList<Product>) myMarket.findByBrand("Kolosok");
        Product[] expected = {products[0], products[4]};
